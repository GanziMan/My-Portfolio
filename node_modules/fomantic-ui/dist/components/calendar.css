...
.ui.calendar.popup > .ui.grid > .column:not(:first-child) {
  padding-left: 0;
}
.ui.calendar.popup > .ui.grid > .column:not(:first-child) > .ui.table {
  border-top-left-radius: 0;
  border-bottom-left-radius: 0;
}
.ui.calendar.popup > .ui.grid > .column:not(:last-child) {
  padding-right: 0;
}
.ui.calendar.popup > .ui.grid > .column:not(:last-child) > .ui.table {
