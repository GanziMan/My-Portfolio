...
export default function Switch({ onChange, style, value, ...props }) {
    ...
    return (React.createElement(TouchableOpacity, { accessibilityRole: "button", tabIndex: 0, activeOpacity: 1.0, ...props, ...onEnterAndClick(onValueChange), style: [styles.wrapper, style] },
...
const MoonIcon = ({ isClicked, ...props }) => {
    ...
    return (React.createElement(Animated.View, { style: [
        ...
        React.createElement(SVG.Svg, { pointerEvents: "none", ...props, style: [styles.moonSvg, props.style], viewBox: "0 0 30 32" },
            React.createElement(SVG.Path, { fill: "white", d: "M22.592 21.504q3.36 0 6.56-1.792-1.344 4.64-5.184 7.616t-8.8 2.976q-6.016 0-10.304-4.288t-4.288-10.336q0-4.928 2.976-8.768t7.584-5.216q-1.792 3.2-1.792 6.56 0 5.504 3.904 9.376t9.344 3.872z" }))));
};
...
const DayNightSwitch = ({ isClicked }) => {
    ...
    return (React.createElement(Animated.View, { ref: ref, style: [
...
const Star = ({ size = 3, x, y, index, isClicked, ...props }) => {
    ...
    return (React.createElement(Animated.View, { ...props, style: [
            styles.star,
            {
                width: size,
                height: size,
...
const Stars = ({ isClicked, ...props }) => {
    ...
    return (React.createElement(Animated.View, { ...props, style: [
        ...
        props.children,
        React.createElement(Star, { isClicked: isClicked, index: 1, size: 2, x: 10, y: 3 }),
        React.createElement(Star, { isClicked: isClicked, index: 2, size: 1, x: 3, y: 7 }),
        React.createElement(Star, { isClicked: isClicked, index: 3, size: 1, x: 12, y: 18 }),
        React.createElement(Star, { isClicked: isClicked, index: 4, size: 1, x: 15, y: 10 }),
        React.createElement(Star, { isClicked: isClicked, index: 5, size: 1, x: 19, y: 4 }),
        React.createElement(Star, { isClicked: isClicked, index: 6, size: 2, x: 22, y: 14 })));
};
const Circle = ({ isClicked, ...props }) => {
    ...
    return (React.createElement(Animated.View, { ...props, ref: ref, style: [
            styles.circle,
            {
